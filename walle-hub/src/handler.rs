...
#[async_trait]
impl EventHandler<v12Event, v12Action, v12Resp> for EventCollector {
...
#[async_trait]
impl EventHandler<v11Event, v11Action, v11Resp> for EventCollector {
    async fn handle(&self, _: ArcBot<v11Action, v11Resp>, event: v11Event) {
        self.event_tx.send(event.try_into().unwrap()).unwrap();
    }
}
